...
<tr><td>ÐÕ Ãû£º</td><td><input name="username" type="text"  id="username" size="25" value="${ passinfo.name }"></td></tr>
<tr><td>Äê Áä£º</td><td><input name="userage" type="text"  id="userage" size="25" value="${ passinfo.age }"></td></tr>
<tr><td>ÐÔ ±ð£º</td><td><input name="usersex" type="text"  id="usersex" size="25" value="${ passinfo.sex }"></td></tr>
<tr><td>µØ Ö·£º</td><td><input name="useraddress" type="text"  id="useraddress" size="25" value="${ passinfo.address }"></td></tr>
<tr><td>ÓÊ Ïä£º</td><td><input name="useremail" type="text"  id="useremail" size="25" value="${ passinfo.email }"></td></tr>
</table>
</span>
<span class="pic7">
...
<td width="104"><a href="Untitled-2.html"><input name="btnBack"  type="submit" id="btnBack"  value="·µ »Ø" onclick="goBack()" /></a></td>
</tr></table></span>
