...
<tr><td>µØ Ö·£º</td><td><input name="useraddress" type="text"  id="useraddress" size="25"></td></tr>
...
<td width="104"><a href="/WEB-INF/jsp/MainFirst.jsp"><input name="btnBack"  type="submit" id="btnBack"  value="·µ »Ø" onclick="goBack()" /></a></td>
</tr></table></span>
...
function addUser() {
		...
		with (document.getElementById("itemForm")) {
			method = "post";
			action = "first.do?command=addInfo&ty=Pass";
			submit();
		}
	}
