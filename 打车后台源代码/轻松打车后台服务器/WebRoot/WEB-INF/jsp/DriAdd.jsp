...
<tr><td width="80">Àà ÐÍ£º</td><td width="312">Ë¾»ú</td></tr>
<tr><td>ÕË ºÅ£º</td><td><input name="userid" type="text"  id="userid" size="25"></td></tr>
<tr><td>ÃÜ Âë£º</td><td><input name="userpsw" type="text"  id="userpsw" size="25"></td></tr>
<tr><td>ÐÕ Ãû£º</td><td><input name="username" type="text"  id="username" size="25"></td></tr>
<tr><td>Äê Áä£º</td><td><input name="userage" type="text"  id="userage" size="25"></td></tr>
<tr><td>ÐÔ ±ð£º</td><td><input name="usersex" type="text"  id="usersex" size="25"></td></tr>
<tr><td>Ö¤¼þºÅ£º</td><td><input name="userlicense" type="text"  id="userlicense" size="25"></td></tr>
<tr><td>³µÅÆºÅ£º</td><td><input name="userplate" type="text"  id="userplate" size="25"></td></tr>
<tr><td>³µ ÐÍ£º</td><td><input name="usermodel" type="text"  id="usermodel" size="25"></td></tr>
<tr><td>ÓÊ Ïä£º</td><td><input name="useremail" type="text"  id="useremail" size="25"></td></tr>
</table>
</span>
<span class="pic7">
<table width="227" height="58">
<tr>
<td width="111"><input name="Add" type="submit" id="Add" value="Ìí ¼Ó" onclick="addUser()" /></td>
...
function addUser() {
		...
		with (document.getElementById("itemForm")) {
			method = "post";
			action = "first.do?command=addInfo&ty=Dri";
			submit();
		}
	}
